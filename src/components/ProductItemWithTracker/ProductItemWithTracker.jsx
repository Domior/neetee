...
import styles from './ProductItemWithTracker.module.css';
...
const ProductItemWithTracker = (props) => {
          ...
          <div className={styles.cardItemInfo}>
            ...
            <div className={styles.cardItemDeliveryContainer}>
              <div className={styles.cardItemDeliveryInfo}>
                <p>Трек-номер:</p>
                <span>UF152445587520</span>
              </div>
              <div className={styles.cardItemDeliveryInfo}>
                <p>Компания доставки:</p>
                <span>EMS express</span>
              </div>
            </div>
...
export default ProductItemWithTracker;
